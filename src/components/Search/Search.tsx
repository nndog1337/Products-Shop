    ...
    <main>
      <section className={styles.search}>
        <div className={styles.searchWrapper}>
          <input ref={ref} className={styles.searchInput} id='searchInput' type="text" placeholder='Введите название товара' />
        ...
        <div className={styles.productsWrapper}>
            ...
            : error ? (<p>Error</p>)
            :  products?.length === 0 
            ? (<p style={{fontSize: '34px', textAlign:'center', marginTop:'20px'}}>По вашему запросу ничего не найдено :(</p>)
            : (<>
